<?php
/**
 * Plugin Name: Hostinger Auto Updates Plugin
 * Plugin URI:  https://www.hostinger.com
 * Description: Disables automatic theme, core, and plugin updates, and routes API and download requests through Hostinger's proxy services.
 * Version:     1.0.3
 * Author:      Hostinger
